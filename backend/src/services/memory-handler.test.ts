...
describe('Memory Handler Service', () => {
  describe('buildMemoryFromRows', () => {
    ...
    it('should handle non-array content gracefully', () => {
      const rows = [
        { type: 'short_term', content: null as unknown as string[] },
        { type: 'long_term', content: 'not an array' as unknown as string[] },
        { type: 'characters', content: 123 as unknown as string[] },
        { type: 'goals', content: { text: 'object' } as unknown as string },
      ]
