import { AUTH_RATE_LIMITS, COOKIE_NAMES, TOKEN_EXPIRATION, } from '../lib/auth-helpers.js';
/**
...
export default async function authRoutes(app) {
    ...
    // POST /auth/refresh
    app.post('/auth/refresh', { config: { rateLimit: refreshRateConfig } }, async (request, reply) => {
